...
EXECUTE msdb.dbo.sysmail_delete_profileaccount_sp @profile_name = 'ETL_KARUNA'
EXECUTE msdb.dbo.sysmail_delete_principalprofile_sp @profile_name = 'ETL_KARUNA'
EXECUTE msdb.dbo.sysmail_delete_account_sp @account_name = 'Gmail1'
EXECUTE msdb.dbo.sysmail_delete_profile_sp @profile_name = 'ETL_KARUNA'
